%% Gaze variability  – DayNight  (rescaled (within participant) + trimmed)
...
all_Y_Night = [];   all_pid_Night = [];
        ...
        title('Gaze variability  – Day vs Night')
        ...
        exportgraphics(gcf,'./Figure/GazeVariability_Day_vs_Night_trimmed.png','Resolution',300)
