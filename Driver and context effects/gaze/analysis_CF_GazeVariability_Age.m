%% Gaze variability  – Age  (rescaled (within participant) + trimmed)
...
all_Y_B = [];  all_pid_B = [];
        ...
        title('Gaze variability  – Age Group A vs B')
        ...
        exportgraphics(gcf,'./Figure/GazeVariability_Age_A_vs_B_trimmed.png','Resolution',300)
