%% Eyelid  – Gender  (rescaled (within participant) + trimmed)
...
all_Y_F = [];  all_pid_F = [];
        ...
        exportgraphics(gcf,'./Figure/Eyelid_Gender_Male_vs_Female_trimmed.png','Resolution',300)
