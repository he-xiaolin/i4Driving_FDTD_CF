%% Eyelid  – Experience  (rescaled (within participant) + trimmed)
...
all_Y_H = [];  all_pid_H = [];
        ...
        ylabel('Eyelid')
        title('Eyelid  – Low vs High Driving Experience')
        ...
        exportgraphics(gcf,'./Figure/Eyelid_Experience_Low_vs_High_trimmed.png','Resolution',300)
